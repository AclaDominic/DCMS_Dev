...
TERMS;
        ...
        AppSetting::set('policy.effective_date', '2025-11-06');
        AppSetting::set('policy.contact_email', 'kreativedent@gmail.com');
        AppSetting::set('policy.contact_phone', '0927 759 2845');
